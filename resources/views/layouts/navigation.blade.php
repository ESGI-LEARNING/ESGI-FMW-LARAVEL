        ...
        @if (Auth::check())
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <x-modules.nav.responsive-nav-link :href="route('profile.edit')">
                        {{ __('Profile') }}
                    </x-modules.nav.responsive-nav-link>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-modules.nav.responsive-nav-link :href="route('logout')"
                                                           onclick="event.preventDefault();
                                            this.closest('form').submit();">
                            {{ __('Log Out') }}
                        </x-modules.nav.responsive-nav-link>
            ...
            @else
                <x-modules.nav.responsive-nav-link :href="route('login')" :active="request()->routeIs('login')">
                    {{ __('title.auth.login') }}
                </x-modules.nav.responsive-nav-link>
                <x-modules.nav.responsive-nav-link :href="route('register')" :active="request()->routeIs('register')">
                    {{ __('title.auth.register') }}
                </x-modules.nav.responsive-nav-link>
            @endauth</div>
        @endif
    </div>
